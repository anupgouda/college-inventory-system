...
function BillMaster() {
  ...
  const getStatusClasses = (status: Bill["status"]) => {
    switch (status) {
      case "Approved":
  ...
  const handlePOChange = (poId: string) => {
    ...
    setForm((previous) => ({
      ...previous,
      purchaseOrderId: poId,
      vendorId: String(selectedPO.vendorId),
      itemName: selectedPO.itemName,
      quantity: String(selectedPO.quantity),
      unitPrice: String(selectedPO.unitPrice),
    }));
  };
  ...
  const updateStatus = async (
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.message || "Failed to update bill status");
      }
    ...
    <div className="min-h-[calc(100vh-82px)] bg-slate-50 px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-[1600px]">
        ...
        <div className="mb-7 flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm text-slate-500">
              Manage vendor bills, purchase order references, approvals,
              and payment status.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="flex min-h-[350px] flex-col items-center justify-center px-6 text-center">
              ...
              <p className="mt-1 max-w-sm text-sm text-slate-500">
                Create your first vendor bill to start managing billing
                and payment records.
              </p>
        ...
        <div className="mt-5 flex flex-col justify-between gap-2 text-xs text-slate-400 sm:flex-row">
          <span>
            Bill Master • College Inventory Management System
          </span>

          <span>
            {bills.length} bill
            {bills.length === 1 ? "" : "s"} in register
          </span>
        </div>
          ...
          <div className="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white shadow-2xl">
            ...
            <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200 bg-white px-6 py-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-slate-500">
                  Add a vendor bill to the billing register.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="BILL002"
                    className="w-full rounded-xl border border-slate-200 px-3.5 py-2.5 text-sm outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-50"
                  />
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <p className="mt-1.5 text-xs text-slate-400">
                    Selecting a purchase order will automatically fill
                    vendor, item, quantity, and unit price.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="5.50"
                      className="w-full rounded-xl border border-slate-200 py-2.5 pl-9 pr-3.5 text-sm outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-50"
                    />
                  </div>
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full resize-none rounded-xl border border-slate-200 px-3.5 py-2.5 text-sm outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-50"
                  />
                </div>
